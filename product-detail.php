                    ...
                    <div class="row product-row">
                        ...
                        <div class="col-7 col-md-12">
                            <div class="product-info">
                                ...
                                <div class="product-info-price"><?= number_format($product['selling_price'], 0, ',', '.') ?>đ</div>
                                <div class="product-quantity-wrapper">
                                    <!-- Nút giảm số lượng -->
                                    <span class="product-quantity-btn" onclick="QualityChange('down')">
                                        <i class='bx bx-minus'></i>
                                    </span>
                                    <!-- Thay đổi thành input để nhập số lượng -->
                                ...
                                <div class="product-actions" style="display: flex; align-items: center;">
                                    <form method="post" action="./functions/ordercode.php">
                                        ...
                                        <?php if (!isset($_SESSION['auth_user']['id'])) { ?>
                                            ...
                                            if ($check == 1) { ?>
                                                <a href="./cart.php">
                                                    <button type="button" class="btn-flat btn-hover">Đã thêm vào giỏ hàng</button>
                                                </a>
                                        <?php
                                            } else {
                                    ...
                                    <form method="post" action="./functions/ordercode.php" style="margin-left: 10px;">
                                        <input type="hidden" name="product_id" value="<?= $product['id'] ?>">
                                        <input type="hidden" name="quantity" id="quantity_buy_now" value="1">
                                        <input type="hidden" name="order" value="true">
                                        <input type="hidden" name="buy_now" value="true">
                                        <button type="submit" class="btn-flat btn-hover">Mua ngay</button>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        ?>
            ...
            <script>
                ...
                function QualityInputChange() {
                    quantity = parseInt(QualityShower.value);
