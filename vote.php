        ...
        <div class="container">
            <div class="box">
                <div class="breadcumb">
                    ...
                    <span><i class='bx bxs-chevrons-right'></i></span>
                    <a href="./purchase-history.php">Giỏ hàng đã mua</a>
                    <span><i class='bx bxs-chevrons-right'></i></span>
                    <a href="#">Đánh giá</a>
                </div>
            </div>
                ...
                <div class="product-info">
                    ...
                    ?>
                        <p style="font-size: 20px; text-align: center;">
                            Mặt hàng này chưa thể vote <a style="color: blue; text-decoration: underline" href="./purchase-history.php">Trở lại</a>
                        </p>
                    <?php
                    } else {
